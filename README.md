...
- **Use Thunder Client for testing APIs**
    ...
    **POST Request:**
    ...
    1. **Create a New Request:** Follow step 1 for a GET request.
    2. **Set the Method:** Select "POST" from the dropdown menu.
    3. **Enter the Request URL:** Input the API endpoint for creating new resources.
    4. **Add Headers (Optional):** Add headers like `Content-Type: application/json` if you're sending JSON data.
    ...
    **PUT Request:**
    ...
    1. **Create a New Request:** Follow step 1 for a GET request.
    2. **Set the Method:** Select "PUT" from the dropdown menu.
    3. **Enter the Request URL:** Input the API endpoint for updating an existing resource.
    4. **Add Headers (Optional):** Add headers like `Content-Type: application/json` if you're sending JSON data.
    5. **Set the Request Body:** Input the updated data in the desired format (JSON, form data, etc.).
    6. **Send the Request:** Click the "Send" button.
    7. **Inspect the Response:**
        - **Status Code:** Check if the status code is 200 (OK) or another expected code.
    ...
    **DELETE Request:**
    ...
    1. **Create a New Request:** Follow step 1 for a GET request.
    2. **Set the Method:** Select "DELETE" from the dropdown menu.
    3. **Enter the Request URL:** Input the API endpoint for deleting a specific resource.
    4. **Add Headers (Optional):** Add any required headers.
